...
var blurbs = {
  ...
  passions: {
    ...
    "blurb-content": "<p>Animal welfare and the environment.</p><p>I have an inherent desire to fix things. …deforestation for palm oil...plastic bags…plastic in oceans…gender inequality...violence against women and women’s rights…refugees ...trophy hunting...poaching. The list is endless.</p>",
  },
  experience: {
    "blurb-header": "Experience",
    "blurb-content": "<span class='company'>AGL Energy, Sydney</span><span class='job'>Group Treasurer, Sep 2014 - present</span><span class='job'>Treasurer, Sep 2012 - Aug 2014</span><span class='job'>Assistant Treasurer, May 2011 - Aug 2012</span><span class='job'>Treasury Manager, Oct 2009 - May 2011</span><br/><span class='company'>HotelClub, Sydney (subsidiary of Orbitz Worldwide)</span><span class='job'>Global Treasury & Risk Manager, Dec 2007 – Oct 2009</span><br/><span class='company'>Hudson Global Resources, Sydney</span><span class='job'>Regional Treasurer, Jul 2005 – Dec 2007</span><br/><span class='company'>JPMorganChase Bank, Sydney</span><span class='job'>Financial Accountant, May 2005 – Jul 2005</span><br/><span class='company'>ANZ Investment Bank, Melbourne</span><span class='job'>Markets Officer, Dec 2004 – Mar 2005</span><br/><span class='company'>Baxter Healthcare SA, Shared Service Centre, Dublin</span><span class='job'>Treasury Accountant, Feb 2002 – Oct 2004</span>",
  },
  achievements: {
...
var shiftRight = function() {
  setTimeout(function() {
    $('.details').fadeIn();
    $('.details-section').animate({'flex-grow': 2});
...
$(document).ready(function() {
  ...
  // $('.flower').on('mouseleave', function() {
  //   $('.details').fadeOut();
  //   $('.right').animate({'flex-grow': 1});
  //   $('.details-section').animate({'flex-grow': 1});
  // })
